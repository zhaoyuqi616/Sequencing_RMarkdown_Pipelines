...
knitr::opts_chunk$set(echo = TRUE,message = FALSE,
    ...
    fig.align='center',
    fig.pos='H',
    fig.path = "omiccircos_plots/",
    dev = c("png", "svg"),
    dpi=500)
```

## code chunk number 1
```{r code chunk number 1, include=TRUE}
## code chunk number 1
...
```
## code chunk number 2
```{r code chunk number 2, include=TRUE}
## code chunk number 2
options(stringsAsFactors = FALSE);
library(OmicCircos); 
...
```
## code chunk number 3
```{r code chunk number 3, include=TRUE}
### code chunk number 3
options(stringsAsFactors = FALSE);
library(OmicCircos); 
...
```
## code chunk number 4
```{r code chunk number 4, include=TRUE}
## code chunk number 4
options(stringsAsFactors = FALSE);
library(OmicCircos);
seg.num     <- 10;
...
```
```{r code chunk number 5, include=TRUE}
###################################################
